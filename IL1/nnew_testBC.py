...
# 读取测试数据集
# csv_path = "../test_data/uniform_noisy_dataset.csv"
# csv_path = "../test_data/Gauss_noisy_dataset_03.csv"
csv_path = "../test_data/Gauss_5lie_02.csv"
...
# 加载预训练模型的参数
model.load_state_dict(torch.load("./models/BC_trained_20240113-222845_model_1.pt"))
