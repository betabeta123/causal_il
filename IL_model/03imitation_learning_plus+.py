...
csv_file_path = '/home/tianlili/data0/CGIL/counfac_aug/output/03noncausal_new_concat/03noncausal_new_cancat_all.csv'
...
# 将测试数据集保存为CSV文件
test_data.to_csv('/home/tianlili/data0/CGIL/data/test_03noncausal_cancat_sequence_data.csv', index=False)#不保存行索引信息
...
save_dir = "/home/tianlili/data0/CGIL/IL_model/logs3"
