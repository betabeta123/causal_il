...
log_dir ="D:/A项目文件夹/imitationProject/imitation_learning/logs/" + timestamp
writer = SummaryWriter(log_dir)
# 读取CSV文件

csv_file_path = 'D:/A项目文件夹/imitationProject/data/data_process66.csv'
df = pd.read_csv(csv_file_path)

# 划分训练集和测试集
train_data, test_data = train_test_split(df, test_size=0.1, random_state=50)
# 将测试数据集保存为CSV文件
test_data.to_csv('D:/A项目文件夹/imitationProject/data/test_data1.csv', index=False)#不保存行索引信息
...
save_dir = "D:/A项目文件夹/imitationProject/imitation_learning/models"
