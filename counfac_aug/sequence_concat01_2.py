...
bb_data = pd.read_csv('/home/tianlili/data0/CGIL/counfac_aug/output/AUG_causal_sequence_dataset.csv',header=None)#因果顺序数据，
#因果顺序数据需要不断修改数据集
...
# 将新数据保存到 new_data.csv
new_data.to_csv('/home/tianlili/data0/CGIL/counfac_aug/output/new2_cancat_sequence_data.csv', header=None,index=False)
print(f'新数据集 new_concat_sequence_data.csv的行数和列数：{new_data.shape}')
print("新数据集已保存到new_cancat_sequence_data.csv")
